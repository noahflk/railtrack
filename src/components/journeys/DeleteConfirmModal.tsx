          ...
          >
            <div className="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              ...
              <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                ...
                <Button
                  type="secondary"
                  className="mt-3 inline-flex w-full border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm"
                  onClick={onDismiss}
                  ref={cancelButtonRef}
                >
                  {t('cancel')}
